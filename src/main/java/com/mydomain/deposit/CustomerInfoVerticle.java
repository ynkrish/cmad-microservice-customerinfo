...
public class CustomerInfoVerticle extends AbstractVerticle{
	...
	public void start() throws Exception {
		...
		restAPI.get("/customer/:accountNumber").handler(rc -> {
		...
		restAPI.post("/customer/:accountNumber").handler(rc -> {
		...
		System.out.println("CustomerInfo started on port 8090");
	}
	...
	public static void main(String[] args) {
		...
		Vertx.clusteredVertx(options, res -> {
		  if (res.succeeded()) {
		    ...
		    vertx.deployVerticle("com.mydomain.deposit.CustomerInfoVerticle");
		  } else {
		    // failed!
		  }
		});
